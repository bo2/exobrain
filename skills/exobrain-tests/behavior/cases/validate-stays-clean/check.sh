...
readme="$(find_run "$INST" -type f -ipath '*knowledge/gardening/README.md' | head -1)"
[[ -n "$readme" ]] || fail "knowledge/gardening/README.md was not created"
[[ -s "$readme" ]] || fail "knowledge/gardening/README.md is empty"
