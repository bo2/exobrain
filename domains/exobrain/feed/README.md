...
**Cards are public and generic.** Never name a downstream instance's org, internal hosts, ticket prefixes, usernames, or private repos — describe the pattern, not its origin. See [`../propagation.md`](../propagation.md) → Provenance hygiene.
