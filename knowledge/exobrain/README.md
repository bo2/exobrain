...
| File | Covers |
|---|---|
| [`entities.md`](entities.md) | The content types — knowledge domains, workspaces, people/groups — and the "promote, don't link" rule |
...
| [`domains.md`](domains.md) | How to structure a knowledge domain — directory layout, scope design, WIP (`.wip`) domains, the `TIMELINE.md` convention |
