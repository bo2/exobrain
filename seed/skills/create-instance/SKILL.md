...
- `skills.json` — register the copied global skills. Each is a declaration with
  ...
  home scope is wherever the `skills.json` lives): `{ "$schema": "./skills.schema.json", "skills": [ { "name": "exobrain-authoring-audit", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-evolve", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-persist", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-knowledge", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-ab", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-tools", "owner": "", "tier": "optional", "force": true }, { "name": "exobrain-tests", "owner": "", "tier": "optional", "force": true } ] }`.
...
- `skills/` — copy each global skill dir from `$SRC/skills/`: `exobrain-authoring-audit`,
  `exobrain-evolve`, `exobrain-persist`, `exobrain-knowledge`, `exobrain-ab`,
...
Copy `$SRC/knowledge/exobrain/` into `$DST/knowledge/exobrain/` — entities,
...
connection state and establishes it in step 5 from the flags you pass it.
...
- **Reuse, don't reinvent.** Everything except the seed content is a copy of
  `$SRC`. The value you add is the interview and the scope shape — not rewriting
  the framework.
